...
const ROOMS = [
    ...
    { id: 'studio', label: 'Technical Skills', x: 57, y: 55 },    // Monitors stack (right side)
];
                    ...
                    <div className="map-content-clipped">
                        ...
                        <div className="map-container">
                            ...
                            <button
                                ...
                                aria-label="Teleport to Technical Skills room"
                            />
                            ...
                            <div className="map-room-label studio">TECHNICAL<br />SKILLS</div>
