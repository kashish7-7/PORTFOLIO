    ...
    return (
        <div className="sr-overlay" role="complementary" aria-label="Accessible navigation for 3D portfolio">
            ...
            <nav id="sr-main-nav" className="sr-only" aria-label="Portfolio rooms">
                <h1>Kashish— Creative Developer Portfolio</h1>
                <h2>Portfolio Navigation</h2>

                {!hasEntered && (
                    <p>Welcome to Kashish's interactive 3D portfolio. Click or press Enter on the doors to enter.</p>
                )}
                        ...
                        <ul>
                            ...
                            <li>
                                <button onClick={() => teleportTo('studio')} type="button">
                                    Technical Skills — Technologies and experience
                                </button>
                            </li>
                        </ul>
                    </>
                    ...
                    <>
                            ...
                            You are in the {currentRoom === 'about' ? 'About' :
                                currentRoom === 'gallery' ? 'Projects' :
                                    currentRoom === 'contact' ? 'Contact' :
                                        currentRoom === 'studio' ? 'Technical Skills' : currentRoom} room.
                        </p>
                        ...
                        {currentRoom === 'contact' && (
                            <div aria-label="Contact room content">
                                <h3>Contact Me</h3>
                                <p>Find my contact methods: Email, GitHub, and LinkedIn. Click to connect or reach out.</p>
                            </div>
                        )}
                        {currentRoom === 'studio' && (
                            <div aria-label="Technical Skills room content">
                                <h3>Technical Skills</h3>
                                <p>Explore my experience and skills. Start at the floating desk with your experience info, browse the bookshelf of technical skills, and return to explore more.</p>
                            </div>
                        )}
                        ...
                        <ul>
                            ...
                            {currentRoom !== 'studio' && (
                                <li><button onClick={() => teleportTo('studio')} type="button">Go to Technical Skills</button></li>
                            )}
                        </ul>
                    </>
                )}
