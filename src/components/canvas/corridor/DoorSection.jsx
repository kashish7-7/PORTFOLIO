...
const DOOR_TEXTURES = {
    ...
    // Use a neutral door texture for the Studio / Technical Skills door
    // to remove social icons (YouTube / TikTok / Instagram / letter) from the door art.
    'THE STUDIO': '/textures/corridor/doors/drzwiabout.webp',
    'TECHNICAL SKILLS': '/textures/corridor/doors/drzwiabout.webp',
...
const DOOR_PAINTED_TEXTURES = {
    ...
    // Match the neutral painted variant for Studio/Technical Skills as well
    'THE STUDIO': '/textures/corridor/doors/drzwiabout_painted.webp',
    'TECHNICAL SKILLS': '/textures/corridor/doors/drzwiabout_painted.webp',
                ...
                <group position={[wallOffsetX, -0.4, 0]}>
                    ...
                    <group position={[0, doorHeight / 2 + 0.45, 0.08]}>
                        ...
                        */}
                        ...
                        {(label === 'THE GALLERY' || label === 'PROJECTS') && (
                        ...
                        {(label === 'THE STUDIO' || label === 'TECHNICAL SKILLS') && (
                            <group position={[0, 0, 0.01]}>
                                <Text
                                    font="/fonts/CabinSketch-Bold.ttf"
                                    fontSize={0.17}
                                ...
                                {/* Clickable email banner below the sign: opens user's Gmail */}
                                <group position={[0, -0.26, 0.02]}>
                                    <mesh
                                        onClick={() => { window.location.href = 'mailto:kashishkumari485@gmail.com'; }}
