...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for Kashish split effect
   const letters = useMemo(() => [
    { char: 'K', baseX: -1.8, splitDir: -2.0, delay: 0 },
    { char: 'A', baseX: -1.2, splitDir: -1.5, delay: 0 },
    { char: 'S', baseX: -0.6, splitDir: -1.0, delay: 0 },
    { char: 'H', baseX: 0.0, splitDir: 0.0, delay: 0 },
    { char: 'I', baseX: 0.6, splitDir: 1.0, delay: 0 },
    { char: 'S', baseX: 1.2, splitDir: 1.5, delay: 0 },
    { char: 'H', baseX: 1.8, splitDir: 2.0, delay: 0 },
], []);

    // Tagline words for split effect
    const taglineWords = useMemo(() => [
        { text: '<', baseX: -0.85, splitDir: -1.5, delay: 0 },
        { text: 'backend', baseX: -0.4, splitDir: -0.8, delay: 0 },
