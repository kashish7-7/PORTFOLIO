...
const UNIQUE_PROJECTS = [
    {
        id: 'KAAL AI - Live Conversational Chatbot',
        title: 'KAAL AI - Live Conversational Chatbot',
        front: '/textures/gallery/tylkartki.webp',
        painted: '/textures/gallery/tylkartki_painted.webp',
        description: 'Developed and deployed a live, production-ready chatbot using FastAPI with intent classification, multilingual support (English/Hindi/Hinglish), and session-based memory. Integrated LLM-based services with emotion-aware prompting.',
        techStack: [
            '/textures/gallery/pythonlogo.webp',
            '/textures/gallery/fastapi.webp',
            '/textures/gallery/open.webp',
            '/textures/gallery/jslogo.webp'
        ]
    },
    {
        id: 'FastAPI + n8n Job Alert Automation',
        title: 'FastAPI + n8n Job Alert Automation',
        front: '/textures/gallery/tylkartki.webp',
        painted: '/textures/gallery/tylkartki_painted.webp',
        description: 'Built an automated resume-aware job alert system matching resumes with live listings. Real-time notifications via Telegram and automated workflow orchestration using n8n.',
        techStack: [
            '/textures/gallery/n8n.webp',
            '/textures/gallery/telegram.webp',
            '/textures/gallery/pythonlogo.webp',
            '/textures/gallery/fastapi.webp'
        ]
    },
    {
        id: 'MCP & LLM Service Integration',
        title: 'MCP & LLM Service Integration',
        front: '/textures/gallery/tylkartki.webp',
        painted: '/textures/gallery/tylkartki_painted.webp',
        description: 'Extensive work on Model Context Protocol (MCP) for integrating LLM-based services. Building, testing, and maintaining backend systems for AI agents and RAG workflows.',
        techStack: [
            '/textures/gallery/pythonlogo.webp',
            '/textures/gallery/fastapi.webp',
            '/textures/gallery/dbgg.webp',
            '/textures/gallery/postman_painted.webp'
        ]
    },
    {
        id: 'Potfolio Website',
        ...
        front: '/textures/gallery/tylkartki.webp',
        painted: '/textures/gallery/tylkartki_painted.webp',
        description: 'I challenged myself to customize and extend this interactive 3D portfolio on a complex WebGL codebase. Although React was an unknown language to me at the start, I quickly learned its fundamentals to adapt and extend the frontend. This project showcases my ability to reverse-engineer, adapt, and build full-stack interactive applications beyond core backend development.',
     techStack: [
          '/textures/gallery/reactlogo.webp',
    '/textures/gallery/threejslogo.webp',
    '/textures/gallery/gsap.webp',
    '/textures/gallery/jslogo.webp'
...
const PROJECT_COUNT = 4; // Three cards hanging in the gallery
const GAP = 4.0;
...
const GalleryRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    // If already painted, don't append again
              if (path.includes('_painted')) {
              return path;
             }
...
const ProjectCard = memo(forwardRef(({ index, project, clothespinTexture, currentScroll, materials, curve, isSelected, scrollToIndex, onClick, isMobile, isTransitioning, paintProgress, roomOrigin }, ref) => {
    ...
    return (
        ...
        >
            ...
            >
                <mesh>
                    <planeGeometry args={[2, 3.8, 16, 16]} />
                    <PaperMaterial
                        ref={materialRef}
                        color="#ffffff"
                ...
                >
                    ...
                    <Text
                        ...
                        anchorX="center"
                        anchorY="top"
                        maxWidth={1.6} // Maksymalna szerokość zanim zacznie łamać linie
                        lineHeight={1.4}
                        textAlign="center"
                        fillOpacity={0} // Start hidden
                    >
                ...
                <group
                    ...
                    position={[0, 0.35, 0]} // Pomiędzy Project Details a przyciskiem Open Project
                    rotation={[Math.PI, 0, 0]}
                >
                    <Text
                        ref={techTextRef}
