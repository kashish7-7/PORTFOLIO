...
const ContactRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            {/* LINKEDIN */}
            <SocialBarrel
                position={isMobile ? [-1.5, 0.5, -10] : [-4, 0.5, -10]}
                rotation={[0, 0.2, 0]}
                texturePath="/textures/contact/beczka.webp"
                label="LINKEDIN"
                onClick={() => {
                    window.open('https://www.linkedin.com/in/kashish73', '_blank');
            ...
            <SocialBarrel
                ...
                label="GITHUB"
                onClick={() => {
                    window.open('https://github.com/kashish7-7', '_blank');
                    unlockAchievement('contact_choose');
                }}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
         ...
         {  /* <SocialBarrel
            ...
            /> */}
              ...
              <SocialBarrel
                ...
                label="GMAIL"
                onClick={() => {window.open(
            'https://mail.google.com/mail/?view=cm&fs=1&to=kashishkumari485@gmail.com&su=Portfolio Inquiry',
            '_blank'
        );
