...
export const CORRIDOR_TEXTURES = [
    ...
    '/textures/corridor/doors/rysuneknaobraz1.webp',
...
export const GALLERY_TEXTURES = [
    ...
    ...GALLERY_TEXTURES_VERSIONED.flatMap(name => {
        const arr = [`/textures/gallery/${name}.webp`];
        if (name !== 'groq') {
            arr.push(name === 'csslogo' ? `/textures/gallery/css3logo_painted.webp` : `/textures/gallery/${name}_painted.webp`);
        }
        return arr;
    })
];
